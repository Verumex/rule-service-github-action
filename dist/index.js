...
const Routes = __importStar(__nccwpck_require__(259));
 ...
 */
const createExecution = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield node_fetch_1.default(Routes.createExecution(), Object.assign(Object.assign({}, utils_1.fetchOptions("POST")), { body: JSON.stringify(payload) }));
 ...
 */
const getResults = (executionId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        pollAttemptsCount += 1;
        /**
        ...
        if (pollAttemptsCount > maxPollAttemptsCount) {
            throw new Error("Execution timed out with no results (max poll attempts reached).");
        }
        core.info(`Fetching results for execution ID ${executionId} ... attempt #${pollAttemptsCount}`);
        const executionResponse = yield node_fetch_1.default(Routes.getExecution(executionId), utils_1.fetchOptions());
        const executionJson = yield executionResponse.json();
        const { executionState } = executionJson.data.attributes;
        if (executionState === "initiated") {
            core.info("Polling for execution completion...");
            yield wait_1.wait(pollInterval);
            return exports.getResults(executionId);
        }
        const resultsResponse = yield node_fetch_1.default(Routes.getResults(executionId), utils_1.fetchOptions());
        const resultsJson = yield resultsResponse.json();
        return {
            executionState,
...
__exportStar(__nccwpck_require__(35), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getResults = exports.getExecution = exports.createExecution = void 0;
const core = __importStar(__nccwpck_require__(186));
const baseUrl = core.getInput("api_host");
const ruleServiceId = core.getInput("rule_service_id");
const createExecution = () => `${baseUrl}/api/v1/data_pipelines/business_rule_services/${ruleServiceId}/executions`;
exports.createExecution = createExecution;
const getExecution = (executionId) => `${baseUrl}/api/v1/data_pipelines/business_rule_services/${ruleServiceId}/executions/${executionId}`;
exports.getExecution = getExecution;
const getResults = (executionId) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(186));
const api_1 = __nccwpck_require__(614);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const executionId = yield api_1.createExecution();
            if (!executionId) {
                throw new Error("Failed to create business rule service execution.");
            }
            const data = yield api_1.getResults(executionId);
            if (!data) {
